		...
		@if (!$portfolios->isEmpty())
			@foreach ($portfolios as $portfolio)
				<div class="hentry-post group">
					<div class="thumb-img"><img style="width: 55px;" src="{{ asset(env('CORP')) }}/images/projects/{{ $portfolio->img->mini }}" alt="{{ $portfolio->title }}" title="{{ $portfolio->title }}"></div>
					<div class="text">
...
<div class="widget-last widget recent-comments">
	...
	<div class="recent-post recent-comments group">                     
		<div class="the-post group">
			...
			<p class="comment"> hi <a class="goto" href="article.html">&#187;</a></p>
		</div>
