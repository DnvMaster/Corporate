<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="{{ asset(env('MASTER')) }}/style.css" />
...
<div class="bg-shadow">
    ...
    <div id="wrapper" class="group">
        ...
        <div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
            <ul class="slider">
                <li>
                    <div class="slide-holder" style="background:  url('{{ asset(env('MASTER')) }}/images/slider-cycle/xx.jpg') no-repeat center center" style="height:483px;">
                ...
                <li>
                    <div class="slide-holder" style="background:  url('{{ asset(env('MASTER')) }}/images/slider-cycle/00314.jpg') no-repeat center center" style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
                ...
                <li>
                    <div class="slide-holder" style="background:  url('{{ asset(env('MASTER')) }}/images/slider-cycle/dd.jpg') no-repeat center center" style="height:483px;">
                        <div class="slide-content-holder inner" style="height:483px;">
                        </div>
                    </div>
                </li>
            ...
            <div id="yit-widget-area" class="group">
                <div class="yit-widget-content inner group">
                    <div class="widget-first yit-widget widget col1_4 one-fourth col widget-icon-text group">
                        <img class="icon-img" src="{{ asset(env('MASTER')) }}/images/icons/cloud.jpg" alt="" />
                        <h3>Great Design</h3>
                    ...
                    <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
                        <img class="icon-img" src="{{ asset(env('MASTER')) }}/images/icons/blog1.png" alt="" />
                        <div>
        ...
        <div class="mobile-slider">
            <div class="slider fixed-image inner"><img src="{{ asset(env('MASTER')) }}/images/slider-cycle/cycle-fixed.jpg" alt="" /></div>
        </div>
            ...
            <div class="inner group">
                            ...
                            <div class="hentry work group portfolio-sticky portfolio-full-description">
                                <div class="work-thumbnail">
                                    ...
                                    <div class="work-overlay">
                                        ...
                                        <p class="work-overlay-categories"><img src="{{ asset(env('MASTER')) }}/images/categories.png" alt="Categories" /> in: <a href="category.html">Brand Identity</a>, <a href="category.html">Web Design</a></p>
                                    </div>
                                </div>
                ...
                <div class="sidebar group">
                    ...
                    <div class="widget-first widget recent-posts">
                        ...
                        <div class="recent-post group">
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{ asset(env('MASTER')) }}/images/articles/001-55x55.png" alt="001" title="001" /></div>
                                <div class="text">
                            ...
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{ asset(env('MASTER')) }}/images/articles/003-55x55.jpg" alt="003" title="003" /></div>
                                <div class="text">
                            ...
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{ asset(env('MASTER')) }}/images/articles/0037-55x55.jpg" alt="0037" title="0037" /></div>
                                <div class="text">
                    ...
                    <div class="widget-last widget text-image">
                        ...
                        <div class="text-image" style="text-align:left"><img src="{{ asset(env('MASTER')) }}/images/callus.gif" alt="Customer support" /></div>
