        ...
        <div class="bg-shadow">
            <div id="wrapper" class="group">
				...
				<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
				    <ul class="slider">
				        <li>
				            <div class="slide-holder" style="background:  url('{{ asset('corporate/images/slider-cycle/xx.jpg')}}') no-repeat center center" style="height:483px;">
				        ...
				        <li>
				            <div class="slide-holder" style="background:  url('{{ asset('corporate/images/slider-cycle/00314.jpg')}}') no-repeat center center" style="height:483px;">
				                <div class="slide-content-holder inner" style="height:483px;">
				        ...
				        <li>
				            <div class="slide-holder" style="background:  url('{{ asset('corporate/images/slider-cycle/dd.jpg')}}') no-repeat center center" style="height:483px;">
				                <div class="slide-content-holder inner" style="height:483px;">
				                </div>
				            </div>
				        </li>
				    ...
				    <div id="yit-widget-area" class="group">
				        <div class="yit-widget-content inner group">
				            <div class="widget-first yit-widget widget col1_4 one-fourth col widget-icon-text group">
				                <img class="icon-img" src="{{ asset('corporate/images/icons/cloud.jpg') }}" alt="" />		
				                <h3>Great Design</h3>
				            ...
				            <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
				                <img class="icon-img" src="{{ asset('corporate/images/icons/blog1.png') }}" alt="" />        
				                <div>
				...
				<div class="mobile-slider">
				    <div class="slider fixed-image inner"><img src="{{ asset('corporate/images/slider-cycle/cycle-fixed.jpg') }}" alt="" /></div>
				</div>
				                ...
				                <div class="section portfolio">
				                    ...
				                    <div class="hentry work group portfolio-sticky portfolio-full-description">
				                        <div class="work-thumbnail">
				                            <a class="thumb"><img src="{{ asset('corporate/images/projects/0081-385x192.jpg') }}" alt="0081" title="0081" /></a>
				                            <div class="work-overlay">
				                                <h3><a href="project.html">Steep This!</a></h3>
				                                <p class="work-overlay-categories"><img src="{{ asset('corporate/images/categories.png') }}" alt="Categories" /> in: <a href="category.html">Brand Identity</a>, <a href="category.html">Web Design</a></p>
				                            </div>
				                        </div>
				                    ...
				                    <div class="portfolio-projects">
				                        ...
				                        <div class="related_project">
				                            <div class="overlay_a related_img">
				                                <div class="overlay_wrapper">
				                                    <img src="{{ asset('corporate/images/projects/0061-175x175.jpg') }}" alt="0061" title="0061" />						
				                                    <div class="overlay">
				                                        <a class="overlay_img" href="{{ asset('corporate/images/projects/0061.jpg') }}" rel="lightbox" title=""></a>
				                        ...
				                        <div class="related_project">
				                            <div class="overlay_a related_img">
				                                <div class="overlay_wrapper">
				                                    <img src="{{ asset('corporate/images/projects/0071-175x175.jpg') }}" alt="0071" title="0071" />						
				                                    <div class="overlay">
				                                        <a class="overlay_img" href="{{ asset('corporate/images/projects/0071.jpg') }}" rel="lightbox" title=""></a>
				                                        <a class="overlay_project" href="project.html"></a>
				                        ...
				                        <div class="related_project">
				                            <div class="overlay_a related_img">
				                                <div class="overlay_wrapper">
				                                    <img src="{{ asset('corporate/images/projects/009-175x175.jpg') }}" alt="009" title="009" />						
				                                    <div class="overlay">
				                                        <a class="overlay_img" href="{{ asset('corporate/images/projects/009.jpg') }}" rel="lightbox" title=""></a>
				                                        <a class="overlay_project" href="project.html"></a>
				                        ...
				                        <div class="related_project_last related_project">
				                            <div class="overlay_a related_img">
				                                <div class="overlay_wrapper">
				                                    <img src="{{ asset('corporate/images/projects/0011-175x175.jpg') }}" alt="0011" title="0011" />						
				                                    <div class="overlay">
				                                        <a class="overlay_img" href="{{ asset('corporate/images/projects/0011.jpg') }}" rel="lightbox" title=""></a>
				                                        <a class="overlay_project" href="project.html"></a>
