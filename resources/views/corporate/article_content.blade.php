	...
	<div class="hentry hentry-post blog-big group ">
		@if($article)
			...
			<div class="meta group">
				...
				<p class="categories"><span>{{ __('In') }}:&nbsp;<a href="{{ route('articles.category',['alias'=>$article->category->title]) }}" title="{{ __('View all post in') }}&nbsp;{{ $article->category->title }}" rel="category tag">{{ $article->category->title }}</a></span></p>
				<p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ count($article->comments) ? count($article->comments) : 0 }} {{ trans_choice('No comments',count($article->comments)) }}</a></span></p>
			</div>
			<!-- post content -->
				        ...
				        <div class="comment-meta commentmetadata">
				            <div class="intro">
				                <div class="commentDate">
				                    <a href="#comment-2">September 24, 2012 at 1:31 pm</a>
				                </div>
